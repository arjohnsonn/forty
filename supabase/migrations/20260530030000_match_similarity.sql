-- Return the cosine similarity from match_sections_detailed so the Worker can margin-filter: when
-- one course matches far better than the rest (a specific-course question), it drops the weak ones.
